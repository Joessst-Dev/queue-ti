...
The `clients/go-client/` package provides a high-level Producer/Consumer API for building applications that enqueue and dequeue messages from queue-ti's gRPC service.
...
See [clients/go-client/README.md](clients/go-client/README.md) for the full API reference, authentication setup, error handling, and examples.
...
├── go.work                  Go workspace — includes root and clients/go-client modules
├── clients/go-client/              Go client library (separate module)
│   ├── go.mod               Module: github.com/Joessst-Dev/queue-ti/clients/go-client
